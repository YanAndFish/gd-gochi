...
这是一个使用 React、Vite 与 IndexedDB 构建的本地优先奢侈零售概念网站。当前目录包含「粤凳系列 / GUANGDONG STOOL SERIES」、「煲点什么 / WHAT'S SIMMERING」、「粤拖系列 / GUANGDONG FLIP-FLOP SERIES」与「暖水有花样 / WARM WATER IN BLOOM」；粤凳系列收录无靠背方凳「粤凳 01 / GUANGDONG STOOL N°01」、带弧形靠背与一体扶手的「粤凳 02 / GUANGDONG STOOL N°02」，以及三色档案套装。

「粤凳 02」以浅蓝为默认版本，另提供白、深蓝、黄、红、橙五种常设色彩。六款共用 ¥18,800 定价与 EDITION 会籍购买政策，每单最多四件；默认画廊同时展示六色堆叠场景与虚构成年米兰模特造型。

「慢慢滚 / SIMMER DOWN」是一款单柄平底浅煲，仅提供砂褐变体，定价 ¥12,800，目录状态为 `standard / active`。商品采用 EDITION 会籍购买政策，每单最多四件；六张画廊影像包括四个商品视角、一张无人物白色展馆场景，以及一张虚构成年米兰模特轻触短柄的造型场景。两张场景图均明确标为品牌 AI 概念影像。

「踢踢拖拖 / KICKING ABOUT」保留平直圆头鞋床、三点连接人字形宽带与同色外底，提供蓝白、绿白、朱白与通体墨黑四款常设配色，统一定价 ¥6,800。默认蓝白画廊除四个商品视角外，还包含一张无人四色展馆场景与一张虚构成年米兰模特穿用场景；两张场景图均明确标为品牌 AI 概念影像。新增商品由目录自动进入商品总览、所属系列、搜索和新品区域，不替换首页主视觉。

「花里壶哨 / FLASKY BUSINESS」以高身圆筒、圆肩短颈、杯盖与木色内塞为主体，顶部细线提梁和纵向弧形侧把形成两种可见提携方式。商品提供朱红、紫罗兰、水青、桃粉与暖黄五款常设花面，默认朱红，统一定价 ¥15,800；每款包含四个商品视角，默认画廊另有一张无人五色展馆场景与一张虚构成年米兰模特以顶部提梁携带的造型场景，两张场景均明确标为品牌 AI 概念影像。商品使用 EDITION 会籍购买政策，每单最多四件。
