...
这是一个使用 React、Vite 与 IndexedDB 构建的本地优先奢侈零售概念网站。当前目录包含「粤凳系列 / GUANGDONG STOOL SERIES」、「煲点什么 / WHAT'S SIMMERING」与「粤拖系列 / GUANGDONG FLIP-FLOP SERIES」；粤凳系列收录无靠背方凳「粤凳 01 / GUANGDONG STOOL N°01」、带弧形靠背与一体扶手的「粤凳 02 / GUANGDONG STOOL N°02」，以及三色档案套装。
